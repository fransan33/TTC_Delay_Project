...
| `avg_disruptive_gap` | Average min_gap value among incidents where min_gap exceeded 8 minutes — calculated using conditional aggregation to exclude non-disruptive events from the average | Measures how severe the downstream service disruption is when it does occur — a high average indicates more severe downstream impact |
